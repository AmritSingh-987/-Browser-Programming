...
msgInput.addEventListener("input", function () {
  ...
  // Visual warning if remaining characters are less than 10
  if (remaining < 10) {
    msgStats.style.color = "red";
    msgStats.style.fontWeight = "bold";
  } else {
    msgStats.style.color = "black";
    msgStats.style.fontWeight = "normal";
  }
});
...
btnAddApple.onclick = () => dispatch({ type: "ADD", item: { name: "Apple", price: 2 } });
btnAddBanana.onclick = () => dispatch({ type: "ADD", item: { name: "Banana", price: 1 } });
btnRemoveLast.onclick = () => dispatch({ type: "REMOVE_LAST" });
btnCartClear.onclick = () => dispatch({ type: "CLEAR" });
...
// Render saved note on page load if it exists
